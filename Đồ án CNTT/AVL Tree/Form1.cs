...
namespace AVL_Tree
{
    public partial class Form1 : Form
    {
        ...
        private void pictureBox1_Paint(object sender, PaintEventArgs e)
        {
            ...
            foreach (var item in tree.Thanh.Values)
            {
                e.Graphics.DrawLine(new Pen(Color.Black), item.x1, item.y1, item.x2, item.y2);
            }
            foreach (var item in tree.Viet.Values)
            {
        ...
        {
            tree.preOrder(tree.root);
            MessageBox.Show("PreOrder : " + tree.preOrderResult);
            tree.preOrderResult = "";
            tree.inOrderHelper();
        }
        ...
        private void PostOrder_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("PostOrder : " + tree.postOrderResult);
            tree.postOrderResult = "";
            tree.inOrderHelper();
        }
    }
}
